...
## Algorithm
 ...
 SVM for Spam Mail Detection (Initialization Steps):

Import the required Python libraries.

Load the spam mail dataset (spam.csv).

Select the relevant columns (message and label).

Encode the class labels (spam = 1, ham = 0).
...
Define hyperparameters and perform Grid Search for tuning.
